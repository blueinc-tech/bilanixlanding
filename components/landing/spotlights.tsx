      ...
      <div className="max-w-page">
        <div className="grid grid-cols-1 lg:grid-cols-2" style={{ gap: 80, alignItems: 'center' }}>
          <Reveal>
            ...
            <button className="btn-primary" onClick={() => openRegistration()}>Get Started <ArrowRight size={15} /></button>
          </Reveal>
      ...
      <div className="max-w-page">
        <div className="grid grid-cols-1 lg:grid-cols-2" style={{ gap: 80, alignItems: 'center' }}>
          ...
          <Reveal delay={2}>
            ...
            <button className="btn-primary" style={{ background: '#0F0F0F', color: '#fff' }} onClick={() => openRegistration()}>Get Started <ArrowRight size={15} /></button>
          </Reveal>
        </div>
      </div>
    </section>
