  ...
  return (
    <section style={{ background: '#fff', paddingTop: 96, paddingBottom: 0, textAlign: 'center' }}>
      <div className="max-w-page" style={{ padding: '0 20px' }}>
        ...
        <Reveal delay={1}>
          <h1 className="font-heading" style={{ margin: '20px auto 0', maxWidth: 920, fontSize: 'clamp(2.25rem, 4vw, 3.25rem)', fontWeight: 300, lineHeight: 1.1, letterSpacing: '-0.02em', color: '#0F0F0F' }}>
