      ...
      <Dialog open={!!viewCampaign} onOpenChange={() => setViewCampaign(null)}>
        <DialogContent className="sm:max-w-2xl max-h-[85vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>{viewCampaign?.subject}</DialogDescription>
          </DialogHeader>
          {viewCampaign && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div className="rounded-lg bg-muted/50 p-3">
                  ...
                  <p className="font-medium capitalize">{viewCampaign.status}</p>
                </div>
                <div className="rounded-lg bg-muted/50 p-3">
                  <p className="text-muted-foreground">Type</p>
                  <p className="font-medium">{RECIPIENT_TYPE_LABELS[viewCampaign.recipientType] || viewCampaign.recipientType}</p>
                </div>
                <div className="rounded-lg bg-muted/50 p-3">
                  <p className="text-muted-foreground">Sent</p>
                  <p className="font-medium">{viewCampaign.totalSent || 0}</p>
                </div>
                <div className="rounded-lg bg-muted/50 p-3">
                  <p className="text-muted-foreground">Failed</p>
                  <p className="font-medium">{viewCampaign.totalFailed || 0}</p>
                </div>
                <div className="rounded-lg bg-muted/50 p-3">
                  <p className="text-muted-foreground">Opened</p>
                  <p className="font-medium">{viewCampaign.totalOpened || 0}</p>
                </div>
                <div className="rounded-lg bg-muted/50 p-3">
                  <p className="text-muted-foreground">Clicked</p>
                  <p className="font-medium">{viewCampaign.totalClicked || 0}</p>
                </div>
              </div>
              {viewCampaign.body && (
                <div className="space-y-2">
                  ...
                  <div
                    ...
                    dangerouslySetInnerHTML={{ __html: viewCampaign.body }}
                  />
                </div>
              )}
            </div>
